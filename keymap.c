...
[_LOWER] = LAYOUT(
  ...
  _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,                         _______,  _______,  KC_PGDN,  KC_PGUP,  _______,  KC_DEL,
  _______,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,                      _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _______,
  _______,  KC_EQL,   _______,  KC_PLUS,  KC_LCBR,  KC_RCBR,  _______,  _______,  _______,  KC_H,     KC_J,     KC_K,     KC_L,     _______,
                      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______
  ),
...
[_RAISE] = LAYOUT(
  ...
  _______,  _______,  _______,  _______,  KC_PSCR,  _______,                      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_F12,
  _______,  _______,  _______,  _______,  _______,  _______,                      KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LPRN,  KC_RPRN,  _______,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_LBRC,  KC_RBRC,  _______,  _______,  _______,  _______,
                      _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______
  ),
