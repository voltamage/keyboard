 ...
 * | LCtr |   Z  |   X  |   C  |   D  |   V  |-------|    |-------|   K  |   H  |   ,  |   .  |   /  |  \   |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LAlt | LGui |  Esc |Space | / Lower /       \Raise \  |Enter |   :  | RGui | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_COLEMAKDH] = LAYOUT(
  ...
  KC_LCTL,  KC_Z,     KC_X,     KC_C,     KC_D,     KC_V,     _______,  _______,  KC_K,     KC_H,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_BSLS,
                      KC_LALT,  KC_LGUI,  KC_ESC,   KC_SPC,MO(_LOWER), MO(_RAISE),KC_ENT,   KC_COLN,  KC_RGUI,  KC_RALT
  ),
...
[_RAISE] = LAYOUT(
  _______,  _______,  _______,  _______,  _______,  _______,                      _______,  _______,  _______,  _______,  _______,  _______,
  _______,  KC_INS,   KC_PSCR,  KC_APP,   _______,  _______,                      _______,  _______,  _______,  _______,  _______,  _______,
  _______,  KC_LALT,  KC_LCTL,  KC_LSFT,  _______,  KC_CAPS,                      _______,  KC_H,     KC_J,     KC_K,     KC_L,     _______,
